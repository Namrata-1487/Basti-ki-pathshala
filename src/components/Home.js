...
import aboutImage from './images/about-image.webp'; // Importing the about image
import childrenImage from './images/children-image.webp'; // Importing the children image
import childrenImage2 from './images/childrenImage2.webp'; // Importing the second children image
import kanika from './images/kanika.webp'; // Importing the testimonial images
import shreya from './images/Shreya.webp'; // Importing the testimonial images
        ...
        <div className="container bg-white rounded-3 shadow">
          <div className="row p-lg-5 p-0">
            <div className="col-lg-6 mb-4 mb-lg-0 border-end">
              <img src={aboutImage} alt="About Us" className="img-fluid rounded w-100" loading="lazy" />
            </div>
      ...
      <section className="why-education-section container py-5">
        <div className="row">
          ...
          <div className="col-lg-6 text-center">
            <img src={childrenImage} alt="Children studying" className="img-fluid rounded shadow w-75 " loading="lazy" />
          </div>
        </div>
      </section>
      <section className="join-us-section container-fluid bg-light ">
        <div className="row">
          <div className="col-lg-6 p-0">
            <img src={childrenImage2} alt="Children studying 2" className="img-fluid shadow w-100" loading="lazy" />
          </div>
              ...
              <div className="testimonial-card p-5 h-100 rounded shadow-sm bg-light">
                ...
                <div className="text-center mt-4">
                  <img
                    ...
                    className="testimonial-img mb-2 w-25 h-25 rounded-circle shadow" loading="lazy"
                  />
